...
questions[0] = "Trouvez la valeur de x pour l'equation: 4x + 6 = 0";
answers[0] = [];
answers[0][0] = "x = -3/2";
answers[0][1] = "x = 2/3";
answers[0][2] = "x = -6/3";
...
questions[1] = "Trouvez la valeur de x pour l'equation: 5 - 8x = 0";
answers[1] = [];
answers[1][0] = "x = 5/8";
answers[1][1] = "x = -8/5";
answers[1][2] = "x = 3";
...
questions[2] = "Trouvez la valeur de y pour l'equation: 7y - 1 = 2y + 3";
answers[2] = [];
answers[2][0] = "y = 4/5";
answers[2][1] = "y = -5/4";
answers[2][2] = "y = 2/3";
...
questions[3] = "Trouvez la valeur de y pour l'equation: - 8 - 2y = 0";
answers[3] = [];
answers[3][0] = "y = -4";
answers[3][1] = "y = -2/8";
answers[3][2] = "y = 4/8";
...
questions[4] = "Trouvez la valeur de z pour l'equation: 12z + 6 = - 3 + 3z";
answers[4] = [];
answers[4][0] = "z = -1";
answers[4][1] = "z = 1";
answers[4][2] = "z = 12/3";
...
questions[5] = "Trouvez la valeur de z pour l'equation: 10 - 5z = - 2z + 1";
answers[5] = [];
answers[5][0] = "z = 3";
answers[5][1] = "z = 10/2";
answers[5][2] = "z = -10/5";
...
questions[6] = "Trouvez la valeur de y pour l'equation: y - 4 = 8 + 2y";
answers[6] = [];
answers[6][0] = "y = -12";
answers[6][1] = "y = -8/2";
answers[6][2] = "y = 4";
...
questions[7] = "Trouvez la valeur de x pour l'equation: 9 = 7x - 19";
answers[7] = [];
answers[7][0] = "x = 4";
answers[7][1] = "x = 10/7";
answers[7][2] = "x = 9/7";
...
questions[8] = "Trouvez la valeur de y pour l'equation: 2y + 17 = 5y + 2";
answers[8] = [];
answers[8][0] = "y = 5";
answers[8][1] = "y = 19/7";
answers[8][2] = "y = -15/7";
...
questions[9] = "Trouvez la valeur de z pour l'equation: 3z - 25 = 11 - 5z";
answers[9] = [];
answers[9][0] = "z = 9/2";
answers[9][1] = "z = -4";
answers[9][2] = "z = 6";
...
questions[10] = "Trouvez la valeur de x pour l'equation: 0 = 14 - 6x";
answers[10] = [];
answers[10][0] = "x = 7/3";
answers[10][1] = "x = -8";
answers[10][2] = "x = 20";
...
questions[11] = "Trouvez la valeur de y pour l'equation: 0 = 21 + 7y";
answers[11] = [];
answers[11][0] = "y = -3";
answers[11][1] = "y = 7/21";
answers[11][2] = "y = 3";
...
questions[12] = "Trouvez la valeur de z pour l'equation: 14z = 4z + 40";
answers[12] = [];
answers[12][0] = "z = 4";
answers[12][1] = "z = -4";
answers[12][2] = "z = 10";
